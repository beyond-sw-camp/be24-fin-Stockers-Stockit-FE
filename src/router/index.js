...
import StoreMonitoringView from '@/views/store/StoreMonitoringView.vue'
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/store/monitoring', name: 'store-monitoring', component: StoreMonitoringView, meta: { requiresAuth: true, role: 'store' } },
